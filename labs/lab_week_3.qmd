...
`my function <- function(x){x - mean(x, na.rm = TRUE)}`
...
Task 2: Write a function that, when fed 3 vectors, will calculate their means and give you the difference. Once you are conffident your code is working, test it for the following 3 vectors: $(4,10,38)$, $(26,29,21,100)$, and $(84, 87, 106, 200)$.
...
What do you think the following piece of code is doing? After we discuss the code,
