...
subtitle: "Part 1. Probability (part b)"
author: "Andy Eggers"
format: 
  revealjs:
    smaller: false
...
Let $Y$ denote whether a single ball drawn from an urn with equal number of blue and black balls is blue.
...
Think about marginal PDF, conditional PDF.
...
dat |> 
  mutate(z = mvtnorm::dmvnorm(as.matrix(dat), sigma = cbind(c(1, .7), c(.7, 1)))) -> datt2
